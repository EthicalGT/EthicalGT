...
const SkillStackContainer = () => {
    ...
    const skillsData = {
        ...
        Frameworks: [
            { icon: "fa-solid fa-folder-tree", label: "SpringBoot" },
            { icon: "fa-solid fa-folder-tree", label: "Spring" },
            { icon: "fa-solid fa-folder-tree", label: "Echo" },
            { icon: "fa-solid fa-folder-tree", label: "Rocket" },
            { icon: "fa-solid fa-folder-tree", label: "Django" },
            { icon: "fa-solid fa-folder-tree", label: "Flask" },
        ],
        Databases: [
            { icon: "fa-solid fa-database", label: "MongoDB" },
